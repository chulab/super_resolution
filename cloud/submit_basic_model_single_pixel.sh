...
gcloud ml-engine jobs submit training $JOB_NAME \
    ...
    --module-name trainer.train_basic_model_single_pixel\
...
#    --warm_start_from_dir gs://chu_super_resolution_experiment/basic_single_pixel_08_04_2019_15_59_01
