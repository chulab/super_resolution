...
def poisson_noise(
  ...
  """Adds poissonian noise to a distribution and optionally normalizes test_output.
  ...
  integer number of scatterers present in each pixel. The test_output may be
  ...
  Args:
    ...
    normalize_output: bool. If true then test_output is normalized between 0 and 1.
