"""Main module for training model builder."""
...
from trainer import model_builder as model
...
def main():
  ...
  if args.mode==_TRAIN:
    ...
    steps, _ = plot_utils.get_all_tensor_from_tensorboard(tb_dir,
      'predictions/distribution_tensor')
    steps = sorted(list(dict.fromkeys(steps)))
    summaries.summarize_model_builder(args, observation_spec, hparams, steps,
      tb_dir, save_dir)
